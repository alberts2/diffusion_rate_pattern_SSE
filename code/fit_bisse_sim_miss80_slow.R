...
in_fp  = paste0(fp,"data/Simulation/slow_rates_80percent_miss/combined_slow/")
...
# save output
write.table(treeset_slow_df,paste0(out_fp,"bisse_slow_miss80_summary.csv"),sep = ";",row.names = F)
