...
in_fp  = paste0(fp,"data/Simulation/no_rejection_states/slow_rates_20percent_miss/combined_slow/")
...
# save output
write.table(treeset_slow_df,paste0(out_fp,"bisse_slow_miss20_summary_no_rejection_sampling.csv"),sep = ";",row.names = F)
