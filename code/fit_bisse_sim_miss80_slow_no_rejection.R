...
in_fp  = paste0(fp,"data/Simulation/no_rejection_states/slow_rates_80percent_miss_more/combined_slow/")
...
# save output
write.table(treeset_slow_df,paste0(out_fp,"bisse_slow_miss80_summary_no_rejection_more.csv"),sep = ";",row.names = F)
