...
in_fp  = paste0(fp,"data/Simulation/no_rejection_states/fast_rates_80percent_miss_more/combined_fast/")
...
# save output
write.table(treeset_fast_df,paste0(out_fp,"bisse_fast_miss80_summary_no_rejection_more.csv"),sep = ";",row.names = F)
