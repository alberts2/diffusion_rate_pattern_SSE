...
in_fp  = paste0(fp,"data/Simulation/fast_rates_40percent_miss/combined_fast/")
...
# save output
write.table(treeset_fast_df,paste0(out_fp,"bisse_fast_miss40_summary_sampling.csv"),sep = ";",row.names = F)
