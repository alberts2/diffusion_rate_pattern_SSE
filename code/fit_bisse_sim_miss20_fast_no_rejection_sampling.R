...
in_fp  = paste0(fp,"data/Simulation/no_rejection_states/fast_rates_20percent_miss/combined_fast/")
...
# save output
write.table(treeset_fast_df,paste0(out_fp,"bisse_fast_miss20_summary_no_rejection_sampling.csv"),sep = ";",row.names = F)
